...
/**
 * IjkMediaMetadataRetriever class provides a unified interface for retrieving
...
public class IjkMediaMetadataRetriever
{
    ...
    public IjkMediaMetadataRetriever(IjkLibLoader libLoader) {
